...
### cugo_wait
- 【説明】
  - CuGoArduinoMiddleUserProgramming内で利用する停止関数です。
  - delay関数は割り込み処理に影響されるため、cugo_waitをdelayの代わりに利用することを強く推奨します。
- 【構文】
...
中級車向けプログラミングにおいてMotorControllerクラスを利用する際に便利な関数を紹介します。
<a id="anchor4-1"></a>

### driveMotor()
- 【説明】
  - setTargetRpmで指定した速度になるようモーターへサーボ入力します。
